...
/*   Updated: 2016/11/13 07:11:00 by syusof           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_ls_run_p1_p1(t_lsto *lst1, t_lsto *lstcmd, t_ind *ind)
{
	if (ind->indillegal != 0)
		return (1);
	else if (ind->indl == 1 && ind->indreverse == 1 && ind->indr == 1
			&& ind->inda == 1 && ind->indt == 1)
	{
		ft_printlatrreversedir((char*)(lst1->content), lstcmd, ind);
		return (1);
	}
	else if (ind->indreverse == 1 && ind->indr == 1 && ind->inda == 1
			&& ind->indt == 1)
	{
...
{
	if (ind->indreverse == 1 && ind->indr == 1 && ind->indt == 1
			&& ind->indl == 1)
	{
