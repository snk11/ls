...
ft_getyear_str.c ft_getday_str.c ft_getlinkpath.c ft_checkdir.c ft_copylst1.c \
ft_curs.c
...
ft_getyear_str.o ft_getday_str.o ft_getlinkpath.o ft_checkdir.o ft_copylst1.o \
ft_curs.o
